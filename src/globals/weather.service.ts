...
export class WeatherService {
  ...
  // define location here  swap data between route components
  // this will not be necessary when angular2's router is finished in rc2
  // see  http://stackoverflow.com/questions/34363792/angular2-using-inputs-with-router-outlets
  ...
  getWeather(location): Observable<Weather[]> {
    return this.http.get(this.serviceUrls.byName(this.weatherLocation))
